...
lint-py:  ## run python linter with ruff
	python -m ruff check turtles
	python -m ruff format --check turtles
...
fix-py:  ## fix python formatting with ruff
	python -m ruff check --fix turtles
	python -m ruff format turtles
...
test-py:  ## run python tests
	python -m pytest -v turtles/tests

# alias
tests-py: test-py

coverage-py:  ## run python tests and collect test coverage
	python -m pytest -v turtles/tests --cov=turtles --cov-report term-missing --cov-report xml

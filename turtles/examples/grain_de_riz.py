...
modulation with many overlapping passes, creating the characteristic fine
"rice grain" texture seen in luxury watchmaking.
"""
...
def main():
    ...
    # Create multi-pass run with many passes for dense grain texture
    run = RoseEngineLatheRun(config, bit, num_passes=80)
    run.generate()
